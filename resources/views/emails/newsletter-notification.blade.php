                ...
                <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 0 15px rgba(0,0,0,0.06);">
                    ...
                    <tr>
                        <td style="padding:36px 32px 12px;">
                            <p style="margin:0 0 8px;color:#ff695f;font-size:13px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;">Newsletter</p>
                            <h1 style="margin:0 0 16px;font-size:26px;line-height:1.3;color:#2a2a2a;">New subscriber</h1>
                            <p style="margin:0 0 22px;font-size:15px;line-height:1.8;color:#7a7a7a;">
                                Someone just subscribed to the {{ $siteName }} newsletter.
                            </p>

                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border-collapse:collapse;">
                                <tr>
                                    <td style="padding:12px 0;width:140px;font-size:13px;font-weight:700;color:#2a2a2a;vertical-align:top;">Email</td>
                                    <td style="padding:12px 0;font-size:15px;color:#7a7a7a;vertical-align:top;">
                                        <a href="mailto:{{ $subscriber->email }}" style="color:#03a4ed;text-decoration:none;">{{ $subscriber->email }}</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="padding:28px 32px 32px;border-top:1px solid #eef3f7;">
                            <p style="margin:0;font-size:13px;line-height:1.7;color:#9aa3ab;text-align:center;">
                                Subscribed {{ $subscriber->created_at?->format('d M Y, h:i A') }} · {{ $siteName }}
                            </p>
                        </td>
                    </tr>
                </table>
