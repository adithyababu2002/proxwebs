...
<body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-12">
          <nav class="main-nav">
            <!-- ***** Logo Start ***** -->
            <a href="/onix" class="logo">
              <img src="/proxwebs/images/LOGO100.png" alt="Onix Digital">
            </a>
            <!-- ***** Logo End ***** -->
            <!-- ***** Menu Start ***** -->
            <ul class="nav">
      ...
      <div class="row">
        <div class="col-lg-6 align-self-center">
          <div class="left-image">
            <img src="/images/about-left-image.png" alt="Two Girls working together">
          </div>
        </div>
        <div class="col-lg-6">
          <div class="section-heading">
              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                  <div class="menu">
                    ...
                    <div>
                      <div class="thumb">
                        <img src="/images/video-thumb-03.png" alt="Marketing">
                        <div class="inner-content">
                          <h4>Project Three</h4>
                          <span>Digital &amp; Marketing</span>
                        </div>
                    ...
                    <div>
                      <div class="thumb">
                        <img src="/images/video-thumb-04.png" alt="SEO Work">
                        <div class="inner-content">
  ...
  <script src="/onix/assets/js/owl-carousel.js"></script>
  <script src="/onix/assets/js/animation.js"></script>
  <script src="/onix/assets/js/imagesloaded.js"></script>
  <script src="/onix/assets/js/custom.js"></script>
